...
namespace SURF_Test
{
    public partial class Form1 : Form
    {
        ...
        private void tbFndImage_TextChanged(object sender, EventArgs e)
        {
        ...
        public Mat Draw(Mat modelImage, Mat observedImage, out long matchTime)
        {
            ...
            using (VectorOfVectorOfDMatch matches = new VectorOfVectorOfDMatch())
            {
                ...
                if (homography != null)
                {
                    ...
                    {
                        CvInvoke.Polylines(result, vp, true, new MCvScalar(125, 120, 190, 155), 5);
                    }
